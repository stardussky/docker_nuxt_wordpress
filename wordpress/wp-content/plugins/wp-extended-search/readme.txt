...
>You can download it from [here](https://downloads.wordpress.org/plugin/wp-extended-search.zip) and share your valuable feedback in the [support forum](https://wordpress.org/support/plugin/wp-extended-search/).
